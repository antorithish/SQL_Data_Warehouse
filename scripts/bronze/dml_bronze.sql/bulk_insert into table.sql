...
BEGIN
    ...
    BEGIN TRY
        ...
        SET @start_time = GETDATE();
        PRINT '>> Truncating Table: bronze.cust_prod_info';
        TRUNCATE TABLE bronze.cust_prod_info;

        PRINT '>> Inserting Data Into: bronze.cust_prod_info';
        ...
        SET @start_time = GETDATE();
        PRINT '>> Truncating Table: bronze.cust_sales_details';
        TRUNCATE TABLE bronze.cust_sales_details;

        PRINT '>> Inserting Data Into: bronze.cust_sales_details';
